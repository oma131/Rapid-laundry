    ...
    <div className="max-w-full border-b border-darkgrey  px-2  md:px-12 bg-white shadow-xl text-black py-4">
      <div className="px-8">
        <div className="flex justify-between items-center">
            ...
            <span className="icon-[ep--search] text-darkgrey pointer-events-none w-6 h-6  absolute top-1/2 transform -translate-y-1/2 left-3"></span> 
                <input
                type="text"
                placeholder="Search"
           ...
           <div className="h-3 w-3 z-0 bg-agreen rounded-full absolute top-[2.2rem] left-[2.1rem]"></div>
                <img
                src={Admin} // Add your profile picture source here
                alt="Profile"
                className="  lg:w-12 z-50 lg:h-12 rounded-full object-cover"
